...
class Crawler(object, metaclass=ProxyMetaclass):
    ...
    def crawl_xicidaili(self):
        for i in range(1, 3):
            ...
            headers = {
                ...
                'Cookie': '_free_proxy_session=BAh7B0kiD3Nlc3Npb25faWQGOgZFVEkiJTk2MTYyYzdhYWQ4MTZlZTEwZGNhMzVlMTU0NDI3ZWMzBjsAVEkiEF9jc3JmX3Rva2VuBjsARkkiMXlFVXpyZi91aUx5SUVzb3huc3NBK0h5bEFudTNHUEZNY1RwZDRGdlJlYWM9BjsARg%3D%3D--6b1e23ef9da3fb532dc76133fbcea887f24b82b5; Hm_lvt_0cf76c77469e965d2957f0553e6ecf59=1532765848; Hm_lpvt_0cf76c77469e965d2957f0553e6ecf59=1532765848',
    ...
    def crawl_data5u(self):
        ...
        headers = {
            ...
            'Cookie': 'JSESSIONID=BC6E314E8B9B39DD67917EC895CF718F',
            'Host': 'www.data5u.com',
            'Referer': 'http://www.data5u.com/free/index.html',
            'Upgrade-Insecure-Requests': '1',
